...
import { Store, MessageCircle, CreditCard, TrendingUp, Users, Zap, CheckCircle, ArrowRight, BarChart3, Bell, Package, Truck, DollarSign, Clock, Star, Check, RotateCw } from 'lucide-react'
    ...
    <div className="max-w-2xl">
      ...
      <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
		...
		<section className="py-20 bg-gradient-to-br from-fuchsia-900 to-fuchsia-800">
			...
			<Link
				href="https://wa.me/5492804505920"
				target="_blank"
				rel="noopener noreferrer"
				className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#1ebe57] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300"
